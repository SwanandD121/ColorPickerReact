            ...
            <div className='container-lg mt-1 px-5' style={{ height: "700px", backgroundColor: "#bfa3cc" }}>
                ...
                <div className="container-lg mt-3 border" style={{ backgroundColor: this.state.color, height: "550px", borderRadius: "20px", boxShadow: "2px 2px 8px black" }}>
                    ...
                    <div className='d-flex justify-content-center align-items-center'>
                        <button id="clickButton" className='text-light font-bold border-0 px-3 py-2' onClick={this.handleColor} style={{ backgroundColor: this.state.color }}>Pick a color</button>
                    </div>
                </div>
            </div>
        );
